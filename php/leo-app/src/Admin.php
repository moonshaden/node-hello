        ...
        return [
            'scholarships' => [
                ...
                'fields' => array_merge([
                    ...
                    ['key' => 'photoUrl', 'type' => 'text', 'label' => 'Photograph', 'placeholder' => '/img/scholarships/<slug>.jpg', 'help' => 'Shown at the top of the page. Leave blank for none.'],
                    ['key' => 'photoAlt', 'type' => 'text', 'label' => 'Photograph description', 'help' => 'What the picture shows, for a screen reader.'],
                    ['key' => 'photoWidth', 'type' => 'text', 'label' => 'Photograph width in pixels', 'help' => 'With the height, reserves the space before the picture loads. A taller-than-wide picture floats beside the copy.'],
                    ['key' => 'photoHeight', 'type' => 'text', 'label' => 'Photograph height in pixels'],
