  ...
  <div class="wrap">
    <div class="foot-grid">
      ...
      <div>
        <h4>Scholarships</h4>
        <ul>
          <li><a href="/scholarships">Available scholarships</a></li>
          <li><a href="/recipients">Scholarship recipients</a></li>
          <?php foreach ($navPages as $navPage): ?>
            <li><a href="/<?= e($navPage['slug'] ?? '') ?>"><?= e($navPage['navLabel'] ?? $navPage['title'] ?? '') ?></a></li>
          <?php endforeach; ?>
        </ul>
      </div>
      <div>
        ...
        <ul>
          ...
          <?php if (!empty($site['facebookUrl'])): ?><li><a href="<?= e($site['facebookUrl']) ?>">Facebook</a></li><?php endif; ?>
        </ul>
      </div>
    </div>
    <div class="foot-legal">
      ...
      <a href="/admin" style="float:right">Staff sign in</a>
    </div>
  </div>
</footer>
