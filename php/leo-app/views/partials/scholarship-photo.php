...
// 227px photograph to fill would upscale it. **Nothing here is ever drawn past
// its own pixels** -- see the `max-width` note in the stylesheet.
//
// There was briefly a `fill` opt-in, for the one logo whose only published file
// was 146x91 and therefore looked small beside every other mark. The client
// supplied a 1672x941 original instead, which is the fix that is not soft, and
// the exception went with it. If a picture ever looks too small here again, ask
// for a bigger file rather than reinstating the flag.
//
