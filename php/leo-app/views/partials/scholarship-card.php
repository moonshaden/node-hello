<article class="card">
  ...
  <h3 style="margin-top:14px"><a href="/scholarships/<?= e($scholarship['slug'] ?? '') ?>"><?= e($scholarship['name'] ?? '') ?></a></h3>
  ...
  <div class="card-foot">
    <a class="btn btn-sm <?= $scholarship['isOpen'] ? 'btn-ink' : 'btn-outline' ?>" href="/scholarships/<?= e($scholarship['slug'] ?? '') ?>">
