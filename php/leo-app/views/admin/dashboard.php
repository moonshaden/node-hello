...
<div class="panel">
  ...
  <table class="rows">
    ...
    <?php foreach ($scholarships as $item): ?>
      <tr>
        <td class="rowtitle"><a href="/admin/scholarships/<?= e($item['id'] ?? '') ?>"><?= e($item['name'] ?? '') ?></a></td>
        ...
        <td class="actions"><a class="btn btn-sm btn-outline" href="/admin/scholarships/<?= e($item['id'] ?? '') ?>">Edit</a></td>
      </tr>
    <?php endforeach; ?>
  </table>
</div>
...
<div class="panel">
  ...
  <p class="muted small">
    <a href="/admin/recipients"><?= count($recipients) ?> recipients</a> ·
    <a href="/admin/pages"><?= (int) $pageCount ?> pages</a> ·
    <a href="/admin/announcements"><?= (int) $announcementCount ?> announcements</a>
  </p>
